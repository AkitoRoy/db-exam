...
function sendThankYouEmail(email) {
  ...
  var mailOptions = {
    from: 'The Retrobutionist Guild>',
    to: email,
    subject: 'Our Appreciation!',
    text: 'Our Guild designs games for the use of the public us at The Retrobutioniest Guild would appreciate any feedback possible.',
    html: '<h1> our first game will be of a man usinghis skills of assassination to protect the ones he loves.</p>'
  };
